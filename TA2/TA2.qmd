...
$$L(\beta, \alpha_1,...,\alpha_N \mid y, x) = \prod_{i=1}^N \prod_{t=1}^T P(y_{it} \mid \alpha_i, x_i, \beta)$$
:::
...
<div style="text-align: center;">
  <img src="figures/scatter_raw.png" width="60%">
</div>
:::

::: {.column width="50%"}
<div style="text-align: center;">
  <img src="figures/bin_basic.png" width="60%">
</div>
:::
:::
...
<div style="text-align: center;">
  <img src="figures/bin_basic_controls.png" width="40%">
</div>

**Problem:** assumes linearity in controls, if this is not true $\rightarrow$ misleading plot.
...
<div style="text-align: center;">
  <img src="figures/bscat_union.png" width="50%">
</div>
...
- Small $h$: very local averaging → low bias, high variance (overfitting)
- Large $h$: heavy smoothing → high bias, low variance (underfitting)
- Intermediate $h$: best compromise

<div style="text-align: center;">
  <img src="figures/nw_bandwidth_comparison.png" width="50%">
</div>
...
<div style="text-align: center;">
  <img src="figures/nw_vs_ll.png" width="40%">
</div>
...
<div style="text-align: center;">
  <img src="figures/npregress_plot.png" width="40%">
</div>
...
$$\hat{E}[lprice|ldist_i] = \hat{m}_y(ldist_i) \quad \text{and} \quad \hat{E}[X|ldist_i] = \hat{m}_X(ldist_i)$$
:::

:::{.fragment}
2. Partial out distance:
$$\tilde{lprice}_i = lprice_i - \hat{m}_y(ldist_i) \quad \text{and} \quad \tilde{X}_i = X_i - \hat{m}_X(ldist_i)$$
:::

:::{.fragment}
3. OLS:
$$\tilde{lprice}_i = \tilde{X}_i'\beta + u_i \quad \Rightarrow \quad \hat{\beta}_{PLM}$$
:::
...
<div style="text-align: center;">
  <img src="figures/semipar.png" width="40%">
</div>